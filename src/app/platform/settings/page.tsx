...
export default function SettingsPage() {
  return (
    <div className="space-y-8">
      <PageHead code="MF · 06 · Settings" title="Account and eligibility" />
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <Sheet label="Eligibility · attestations for this wallet" meta="no personal data on-chain">
        <p className="mb-4 text-[13px] leading-relaxed text-mf-muted">
        ...
        {attestations.loading && !attestations.data ? (
          ...
          <ul className="space-y-2">
            {ROLES.map((role) => {
              ...
              return (
                <li key={role} className="flex items-center justify-between border border-mf-line bg-mf-paper px-3 py-2.5">
                  <div>
                    <div className="font-mono text-[12px] text-mf-ink">{role}</div>
                    <div className="text-[11px] text-mf-faint">
                      {a
        ...
        <p className="mt-4 text-[12px] text-mf-faint">
